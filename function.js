...
btn5.addEventListener("click", () => {
    ...
    tdTotalLabel.style.fontWeight = "bold";
    tdTotalLabel.textContent = "Result";
    tdTotalValue.textContent = `Highest: ${highest} Lowest: ${lowest}`;
...
btn6.addEventListener("click", () => {
    ...
    const lowest = numbersArray[0];
    const highest = numbersArray[numbersArray.length - 1];
    ...
    if(!(numbersArr.length == 0)) {
        ...
        for(let i=0 ; i < numbersArr.length ; i++) {
            ...
            if(!(numbersArr.length == 0)) {
                ...
                document.getElementById("lsect").style.display = "inline";
        ...
        document.getElementById("lsect").style.display = "none";
